...
<head>
    ...
    <title>Thêm Danh Mục Mới - LibraryOS</title>
                ...
                <div class="row">
                    <div class="col-12 col-xl-8">
                        <div class="card form-card">
                            ...
                            <%-- Form Body --%>
                            <div class="p-4">
                                <form id="addCategoryForm" action="${pageContext.request.contextPath}/categories?action=insert" method="post">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" 
                                               value="${categoryName}" required maxlength="100" 
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control" id="description" name="description" 
                                                  ...
                                                  placeholder="Nhập mô tả tóm tắt về loại sách thuộc danh mục này...">${categoryDescription}</textarea>
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label small fw-semibold text-secondary d-flex align-items-center gap-3">
                                            ...
                                            <span id="preview-badge" class="badge-status badge-theme-indigo px-3 py-1.5 fs-7">Xem trước</span>
                                        </label>
                                        
                                        <!-- Hidden Input to store the selected theme -->
                                        <input type="hidden" name="colorTheme" id="colorTheme" value="indigo">
                                        
                                        <!-- Grid of color circles -->
                                        <div class="color-picker-grid">
                                            <div class="color-dot-wrapper active" data-color="indigo" title="Xanh chàm"><div class="color-dot dot-indigo"></div></div>
                                    ...
                                    <div class="d-flex gap-2 justify-content-end">
                                        ...
                                        <button type="submit" class="btn-save hover-lift px-4">
                                            <i class="fa-solid fa-circle-check me-1"></i> Xác nhận thêm
                                        </button>
                                    </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            colorWrappers.forEach(wrapper => {
                wrapper.addEventListener("click", function() {
                    ...
                    previewBadge.className = `badge-status badge-theme-${color} px-3 py-1.5 fs-7`;
                    updatePreviewStyle(color);
                });
            });
